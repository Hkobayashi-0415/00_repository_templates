...
description: "This skill should be used when the user asks to create a new CLI skill, build a reusable Codex/Claude/Copilot skill, or scaffold a community-style skill with templates, validation, and installation workflows."
version: 1.3.0
author: Eric Andrade
created: 2025-02-01
updated: 2026-02-04
