...
The skill-creator-cli automates the entire workflow of creating new CLI skills for GitHub Copilot CLI and Claude Code. It guides you through brainstorming, applies standardized templates, validates content quality, and handles installation-all while following Anthropic's official best practices.
...
ln -sf "$(pwd)/.github/skills/skill-creator-cli" ~/.copilot/skills/skill-creator-cli

# For Claude Code
ln -sf "$(pwd)/.claude/skills/skill-creator-cli" ~/.claude/skills/skill-creator-cli
```
